...
| [docs/PLUGIN-API.md](./docs/PLUGIN-API.md) | 插件契约（v1.3）：插件与核心的唯一契约、7 面 API、安全与命名约束 | 编写插件前必读 |
| [docs/PLUGIN-DEV.md](./docs/PLUGIN-DEV.md) | 插件开发指南：目录结构、register(api)、7 面 API 用法、核心服务消费 | 编写插件 / 扩展功能 |
