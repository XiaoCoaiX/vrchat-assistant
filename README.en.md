...
| [docs/PLUGIN-API.md](./docs/PLUGIN-API.md) | Plugin contract (v1.3): the sole contract between a plugin & core — 7 API facets, safety & naming constraints | Read before writing a plugin |
| [docs/PLUGIN-DEV.md](./docs/PLUGIN-DEV.md) | Plugin development guide: directory structure, register(api), 7 API facets, core service consumption | Writing a plugin / extending features |
