...
| [docs/PLUGIN-API.md](./docs/PLUGIN-API.md) | プラグイン契約（v1.3）：プラグインとコアの唯一の契約 — 7 面 API、安全・命名制約 | プラグイン作成前に必読 |
| [docs/PLUGIN-DEV.md](./docs/PLUGIN-DEV.md) | プラグイン開発ガイド：ディレクトリ構成、register(api)、7 面 API、コアサービス利用 | プラグイン作成 / 機能拡張時 |
